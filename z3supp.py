...
class TestZ3Supp(unittest.TestCase):
    def test_z3Installation(self):
        ...
        s.add(
            parse_smt2_string(
                "(declare-const x Int) (assert (< x 10)) (assert (> x 0))"
            )
        )
    ...
    def test_variable_name_extraction(self):
        ...
        self.assertFalse(
            z3.valid_p(
                "And(x_very____long_name_1__variable_name>5, x_very____long_name_1__variable_name<0)"
            )
        )
        self.assertTrue(
            z3.valid_p(
                "And(x_very____long_name_1__variable_name>5, x_very____long_name_2__variable_name<0)"
            )
        )
